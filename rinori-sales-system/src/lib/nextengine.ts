...
export class NextEngineClient {
    ...
    async searchOrderRows(targetYm: string, shopIds: number[]) {
        ...
        return await this.apiPost('/api_v1_receiveorder_row/search', {
            fields: 'receive_order_id,receive_order_row_no,receive_order_row_goods_id,receive_order_row_goods_name,receive_order_row_quantity,receive_order_row_unit_price,receive_order_row_sub_total_price,receive_order_row_cancel_flag',
